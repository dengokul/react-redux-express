 ...
 * ========================================================= */
 (function(){
     ...
     if (isWindows && !$('body').hasClass('sidebar-mini')){
        ...
        $('.sidebar .sidebar-wrapper, .main-panel-test').perfectScrollbar();
    ...
    initMinimizeSidebar:function(){
        ...
        $('body').on('click','#minimizeSidebar',function(){
            ...
            if(md.misc.sidebar_mini_active == true){
                ...
                if(isWindows){
                    $('.sidebar .sidebar-wrapper, .main-panel-test').perfectScrollbar('destroy');
                }
        ...
        if(!toggle_initialized){
            ...
            $toggle.click(function (){
                ...
                if(mobile_menu_visible == 1) {
                    ...
                    main_panel_height = $('.main-panel-test')[0].scrollHeight;
                    $layer = $('<div class="close-layer"></div>');
                    $layer.css('height',main_panel_height + 'px');
                    $layer.appendTo(".main-panel-test");
